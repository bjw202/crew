...
상태: 반영 (결재 jw, 2026-09-09, message 243. 대상이 crew/common/ 이라 사람이 고쳤다)
적용 커밋: 8a3d0b0 — 들어간 문장은 제안의 export PATH 대신 "command not found 는 환경 고장이니 절대 경로로 한 번 불러 본다" 형태다. 같은 자리에 같은 문을 낸다
