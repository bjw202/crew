...
## 분량 (보내기 전에 직접 센다)
- 보내기 전에 실제로 보낼 글의 글자 수·줄 수·가장 긴 문장의 어절 수를 센다. "600자쯤 될 것이다"는 무효다.
- 한 메시지는 전체 600자와 6줄을 동시에 넘지 않는다. 칸마다의 상한이 아니라 글 전체의 상한이다.
- 한 문장이 25어절을 넘으면 그 산출물은 아직 안 끝난 것이다. 20어절을 목표로 한다.
- 넘치면 지우지 말고 근거 파일로 옮기고 경로만 남긴다.
- 한계·불확실성·"가를 수 없다"는 분량에서 빼지 않는다. 반복되는 근거부터 지운다.
- 센 숫자를 보고 맨 끝에 한 줄로 적는다: (N자 · N줄 · 최장 N어절)
